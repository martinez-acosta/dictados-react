...
import { PlayArrow, Pause, RestartAlt, DeleteOutline, CheckCircle } from '@mui/icons-material'
...
const TONE_SAMPLES_BASE_URL = (typeof import.meta !== 'undefined' && import.meta.env && import.meta.env.VITE_TONE_SAMPLES_BASE_URL)
...
const CLEF_CONFIGS = {
  treble: {
    ...
    sequences: {
      ...
      both: ['c/4', 'd/4', 'e/4', 'f/4', 'g/4', 'a/4', 'b/4', 'c/5', 'b/4', 'a/4', 'g/4', 'f/4', 'e/4', 'd/4', 'c/4']
    }
  },
  bass: {
    name: 'Fa (4ª línea)',
    ...
    sequences: {
      ...
      both: ['e/2', 'f/2', 'g/2', 'a/2', 'b/2', 'c/3', 'd/3', 'e/3', 'd/3', 'c/3', 'b/2', 'a/2', 'g/2', 'f/2', 'e/2']
    }
  },
  bass_3rd: {
    name: 'Fa (3ª línea)',
    ...
    sequences: {
      ...
      both: ['g/2', 'a/2', 'b/2', 'c/3', 'd/3', 'e/3', 'f/3', 'g/3', 'f/3', 'e/3', 'd/3', 'c/3', 'b/2', 'a/2', 'g/2']
    }
  }
}
...
export default function App() {
  ...
  function newDictation() {
    ...
    if (sequentialMode !== 'random') {
      ...
      if (sequentialMode === 'both') { n = 15; if (num !== 15) setNum(15) }
  ...
  function grade() {
    ...
    if (userNotes.some(v => !v)) { const done = userNotes.filter(Boolean).length; setStatus(`Faltan notas: ${done}/${dictation.length}.`); return }
  ...
  return (
    <Container className="wrap">
      <Stack spacing={2}>
        <Typography variant="h5" sx={{ fontWeight: 700, color: '#0b2a50' }}>🎧 Entrenador de dictados melódicos — Clave de {currentClefConfig.name} (4/4)</Typography>

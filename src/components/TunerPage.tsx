        ...
        <Paper sx={{ p: 3 }}>
          <Stack spacing={2}>
              ...
              {readout ? (
                  ...
                  >
                    <Typography
                      ...
                      sx={{
                        fontSize: 72,
                        fontWeight: 800,
                        color: tuningColor(Math.abs(readout.cents)),
                      }}
                    >
                      {readout.note}
                    </Typography>
                ...
                >
                  ...
                  <Typography variant="body1">
                    {running
                      ? "Esperando señal de audio..."
                      : 'Pulsa "Iniciar Afinador" y permite el acceso al micrófono'}
                  </Typography>
                </Box>
              )}
            </Box>
            ...
            <Box sx={{ bgcolor: "#f5f5f5", p: 2, borderRadius: 1 }}>
              ...
              >
                B0 ≈ 30.87 Hz · E1 ≈ 41.20 Hz · A1 ≈ 55.00 Hz · D2 ≈ 73.42 Hz ·
                G2 ≈ 98.00 Hz
              </Typography>
              <Typography
                variant="caption"
                sx={{ display: "block", mt: 1, color: "#666", lineHeight: 1.6 }}
              >
                Detector: YIN (CMNDF) con ventana Hann, gate RMS adaptativo y
                      ...
                      primary={
                        <Stack direction="row" spacing={1} alignItems="center">
                          <Typography
                            ...
                            sx={{
                              fontWeight: 700,
                              color: tuningColor(Math.abs(entry.cents)),
                            }}
                          >
                            {entry.note}
                          </Typography>
                      ...
                      secondary={
                        <Stack spacing={0.5} sx={{ mt: 0.5 }}>
                          <Typography variant="caption" sx={{ color: "#666" }}>
                            {entry.freq.toFixed(2)} Hz ·{" "}
                            {entry.cents > 0 ? "+" : ""}
                            {entry.cents} cents
                          </Typography>
                          <Typography
                            variant="caption"
                            sx={{ color: "#999", fontSize: 10 }}
                          >

...
const ARPEGGIO_GROUPS: readonly ArpeggioGroup[] = [
  ...
  {
    id: "ninths",
    label: "Novenas y Trecenas (5 notas)",
    description:
      "Arpegios de 1-3-5-7-9 y 1-3-5-7-13 para voicings jazz y funk modernos.",
    defaultQualityId: "min9",
    patterns: [
      {
        id: "ninths-ascending",
        label: "Ascendente lineal",
        description: "1-3-5-7-9 para explorar el color extendido completo.",
        order: [0, 1, 2, 3, 4],
      },
      {
        id: "ninths-descending",
        label: "Descendente",
        description: "9-7-5-3-1 para resolver desde la extensión.",
        order: [4, 3, 2, 1, 0],
      },
      {
        id: "ninths-skip",
        label: "Salto de extensión",
        description: "1-5-9-3-7 patrón de saltos para líneas melódicas.",
        order: [0, 2, 4, 1, 3],
      },
      {
        id: "ninths-shell",
        label: "Notas guía + extensión",
        description: "1-3-7-9 (sin quinta) ideal para walking bass moderno.",
        order: [0, 1, 3, 4],
      },
    ],
    qualities: [
      {
        id: "min9",
        symbol: "m9",
        label: "Arpegio menor novena",
        englishLabel: "minor 9 arpeggio",
        intervals: [0, 3, 7, 10, 14],
        degrees: ["1", "b3", "5", "b7", "9"],
        description: "1-b3-5-b7-9. Color dórico suave, grado ii o vi.",
      },
      {
        id: "maj9",
        symbol: "maj9",
        label: "Arpegio mayor novena",
        englishLabel: "major 9 arpeggio",
        intervals: [0, 4, 7, 11, 14],
        degrees: ["1", "3", "5", "7", "9"],
        description: "1-3-5-7-9. Muy luminoso, grado I jónico.",
      },
      {
        id: "dom9",
        symbol: "9",
        label: "Arpegio dominante novena",
        englishLabel: "dominant 9 arpeggio",
        intervals: [0, 4, 7, 10, 14],
        degrees: ["1", "3", "5", "b7", "9"],
        description: "1-3-5-b7-9. Dominante rico en tensión, grado V.",
      },
      {
        id: "dom7b9",
        symbol: "7b9",
        label: "Arpegio dominante b9",
        englishLabel: "dominant 7 flat 9 arpeggio",
        intervals: [0, 4, 7, 10, 13],
        degrees: ["1", "3", "5", "b7", "b9"],
        description: "1-3-5-b7-b9. Muy tenso y oscuro, cadencias menores.",
      },
      {
        id: "dom7s9",
        symbol: "7#9",
        label: "Arpegio dominante #9 (acorde Hendrix)",
        englishLabel: "dominant 7 sharp 9 arpeggio",
        intervals: [0, 4, 7, 10, 15],
        degrees: ["1", "3", "5", "b7", "#9"],
        description: "1-3-5-b7-#9. El acorde de Hendrix. Dominante alterado.",
      },
      {
        id: "min11",
        symbol: "m11",
        label: "Arpegio menor undécima",
        englishLabel: "minor 11 arpeggio",
        intervals: [0, 3, 7, 10, 14, 17],
        degrees: ["1", "b3", "5", "b7", "9", "11"],
        description: "1-b3-5-b7-9-11. Color dórico completo.",
      },
      {
        id: "dom13",
        symbol: "13",
        label: "Arpegio dominante trecena",
        englishLabel: "dominant 13 arpeggio",
        intervals: [0, 4, 7, 10, 14, 21],
        degrees: ["1", "3", "5", "b7", "9", "13"],
        description: "1-3-5-b7-9-13. Dominante completo, jazz clásico.",
      },
      {
        id: "maj13",
        symbol: "maj13",
        label: "Arpegio mayor trecena",
        englishLabel: "major 13 arpeggio",
        intervals: [0, 4, 7, 11, 14, 21],
        degrees: ["1", "3", "5", "7", "9", "13"],
        description: "1-3-5-7-9-13. El acorde mayor más completo.",
      },
      {
        id: "min13",
        symbol: "m13",
        label: "Arpegio menor trecena",
        englishLabel: "minor 13 arpeggio",
        intervals: [0, 3, 7, 10, 14, 21],
        degrees: ["1", "b3", "5", "b7", "9", "13"],
        description: "1-b3-5-b7-9-13. Menor melódico/dórico extendido.",
      },
    ],
  },
];
